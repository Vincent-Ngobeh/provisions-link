      ...
      <CardContent className="pt-4 space-y-2 flex-1 flex flex-col">
        ...
        {product.active_group && (
          <Link to={`/buying-groups/${product.active_group.id}`}>
            <div className="p-3 bg-gradient-to-r from-green-50 to-blue-50 border border-green-200 rounded-md hover:shadow-md hover:from-green-100 hover:to-blue-100 transition-all cursor-pointer group">
              <div className="flex items-start justify-between gap-2">
                ...
                <ArrowRight className="h-5 w-5 text-green-700 shrink-0 group-hover:translate-x-1 transition-transform" />
              </div>
            </div>
          </Link>
        )}
